...
$message='';
$to='';
$subject='Please See More from ttcm';


if(isset($_GET['message'])){
	$id=$_GET['id'];
	$row_id=mysqli_fetch_assoc($con->query("SELECT * FROM `suscribe` WHERE `id`='$id'"));
	$to=$row_id['email'];
...
<body class='container'>
	<div class='card'>
		<div class='card-header'>
			<h1 class='text-center'>Please See More from ttcm</h1>
		</div>
		<div class='card-body'>
			<p>".$m."</p>
