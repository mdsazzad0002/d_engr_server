    ...
    $slect_ad = mysqli_fetch_assoc($con->query("SELECT * FROM `suscription` WHERE `email`='$user_type'"));
    $name = $slect_ad['name'];
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="input-group mb-3">
          ...
          <input value="<?php if (isset($name)) {
                          echo $name;
                        } ?>" required class="form-control" type="text" placeholder="Name" name="name">
        </div>
        <!-- end name -->
        ...
        <div class="input-group mb-3">
          ...
          <input required class="form-control" type="email" disabled placeholder="Email" value="<?php if (isset($email)) {
                                                                                                  echo $email;
                                                                                                } ?>" name="email">
        </div>
        <!-- end email -->
        ...
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1"><i class="bi bi-fonts mr-2"></i> Plan</span>
          </div>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group mb-3">
          ...
          <input value="<?php if (isset($phone)) {
                          echo $phone;
                        } ?>" required class="form-control" type="number" placeholder="phone" name="phone">
        </div>
        <!-- end  phone-->
